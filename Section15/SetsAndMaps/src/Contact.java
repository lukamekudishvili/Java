...
//            String formattedPhone = "(" + phoneToString.substring(0, 3) + ") " + phoneToString.substring(3, 6)
//                    + "-" + phoneToString.substring(6);
            String formattedPhone = "(%s) %s-%s".formatted(phoneToString.substring(0, 3), phoneToString.substring(3, 6),
                    phoneToString.substring(6));
